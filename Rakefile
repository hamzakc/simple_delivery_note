...
desc 'Generate documentation for the simple_delivery_note extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SimpleDeliveryNoteExtension'
...
desc 'Test the simple_delivery_note extension.'
...
namespace :test do
  desc 'Functional test the simple_delivery_note extension.'
  ...
  desc 'Unit test the simple_delivery_note extension.'
